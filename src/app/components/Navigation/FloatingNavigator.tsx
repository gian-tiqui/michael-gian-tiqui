...
const FloatingNavigator = () => {
  ...
  return (
    <>
      <AnimatePresence>
        {scrolledDown && (
          <motion.div
            ...
            className="hidden md:block fixed top-7 right-7 z-50 cursor-pointer bg-neutral-950 rounded-lg p-1"
            onClick={() => alert("hi")}
          >
      ...
      <div className="block md:hidden fixed top-7 right-7 z-50 cursor-pointer bg-neutral-950 rounded-lg p-1">
