...
const Home = () => {
  return (
    <div className="h-[1500px] px-10 pt-48 md:p-64">
      <div className="md:max-w-[950px] mx-auto">
        <p className="text-3xl cursor-default font-mono md:text-6xl text-justify text-white font-extrabold leading-relaxed">
          Hello there 👋, I am{" "}
